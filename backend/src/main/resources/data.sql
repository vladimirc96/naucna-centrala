...
insert into science_paper (id, title, key_term, paper_abstract, price, currency, magazine_id, science_field_id) values (1, 'Mape uma', 'Kljucni pojam', 'Abstrakt', 10, 'USD', 3, 5);
